...
const linkSvg = <svg width="36" height="36" fill="none" className="text-gray900 dark:text-gray100 fill-current">
    <g clipPath="url(#a)">
...
const linkGithubThin = <svg width="36" height="36" fill="none" className="text-gray900 dark:text-gray100 fill-current">
    <path
