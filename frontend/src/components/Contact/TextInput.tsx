        ...
        <div className={className}>
            <div className="relative h-full">
                ...
                <label htmlFor={`input_${name}`}
                       className="absolute text-xs duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-3 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 opacity-70">
                    {label}
                </label>
            </div>
